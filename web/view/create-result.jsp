        ...
        <form action="create" method="post">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="inputPassword4" placeholder="Phone number" name="email">
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="inputCity" name="diag">
            </div>
            <div class="form-group">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control" name="doc_id">
                        <c:forEach items="${requestScope.doctors}" var="doc">
                            <option value="${doc.id}">${doc.user.full_name}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-group col-md-4">
