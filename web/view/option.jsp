            ...
            <div class="row">
                <div class="card" style="width: 25rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="../create-physical" class="btn btn-primary">Create</a>
                    </div>
                </div>
                 <div class="card" style="width: 25rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="../create-eye" class="btn btn-primary">Create</a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <a href="../create-internal" class="btn btn-primary">Create</a>
                    </div>
                </div>
                 <div class="card" style="width: 25rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="../create-maxi" class="btn btn-primary">Create</a>
                    </div>
                </div>
                 <div class="card" style="width: 25rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="../create-ent" class="btn btn-primary">Create</a>
                    </div>
                </div>
                <div class="card" style="width: 25rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="../create-bio" class="btn btn-primary">Create</a>
                    </div>
                </div>
                <div class="card" style="width: 25rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Stats of your biochemical examination.</p>
                        <a href="../create-blood" class="btn btn-primary">Create</a>
                    </div>
                </div>
                <div class="card" style="width: 25rem;">
