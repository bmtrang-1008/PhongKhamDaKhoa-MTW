...
<html>
    ...
    <body>
        ...
        <br/><br/>
        <h1 style="text-align: center">Ear, nose and throat test</h1>
        <div class="container">
        <form action="update-ent" method="post">

            <div class="form-group col-md-10">
                <label for="inputCity">&nbsp;&nbsp;Hearing test</label>
                <input type="text" class="form-control" id="inputCity" name="hear">
            </div>
            <div class="form-group col-md-10">
                <label for="inputCity">&nbsp;&nbsp;Nose and throat test</label>
                <input type="text" class="form-control" id="inputCity" name="nose">
            </div>
